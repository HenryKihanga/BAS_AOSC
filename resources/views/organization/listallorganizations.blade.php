            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('showAllOrganizations') }}">list of registered organizations</a></li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-hover ">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="width: 20%">Name of Organization</th>
                                ...
                                <tbody id="tableData">
                                    ...
                                    @endphp
                                            <tr>
                                                ...
                                                <td class="filterable-cell" style="width: 20%">{{ $organization->organization_name }}</td>
