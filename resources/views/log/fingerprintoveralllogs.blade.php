...
@section('navitem')
    <nav class="mt-2 myNavtab">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ route('fingerprintoverallLogs') }}" class="nav-link active" onclick="toggle_active_class()">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('fingerprintoverallLogs') }}">finger print overall logs</a></li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
