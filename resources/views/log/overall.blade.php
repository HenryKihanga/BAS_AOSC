...
@section('navitem')
    <nav class="mt-2 myNavtab">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ route('overallLogs') }}" class="nav-link active" onclick="toggle_active_class()">
            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#fingerprint" data-toggle="tab">Fingerprint
                                Logs</a></li>
                                                ...
                                                <tbody>
                                                    @foreach ($logs as $log)
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%"><span class="badge bg-danger">Absente</span>
                                                                </td>
                                                            </tr>
                                                    @endforeach
                                                            ...
                                                            @foreach ($logs as $log)
                                                                @if ($log->log_type == 'fingerprint')
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 15%">
                                                                            {{ date('Y-m-d') }}</td>
                                                                        <td><span class="badge bg-danger">Absente</span>
                                                                        </td>
                                                                    </tr>
                                                                @endif
