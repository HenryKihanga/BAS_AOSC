...
class LogController extends Controller
{
    ...
    public function rfidOverallLogs()
    {
    ...
    public function usersPresentToday()
    {
    ...
    public function usersAbsenteToday()
    {
    ...
    public function nonSensitiveLogs()
    {
        $logs = Log::all();
        $nonSensitiveLogs = [];
        foreach ($logs as $log) {
